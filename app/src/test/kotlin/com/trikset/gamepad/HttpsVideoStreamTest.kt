...
import com.trikset.gamepad.mjpeg.HttpsMjpegServer
...
/**
 * E3 end-to-end over the wire: the https branch of `VideoStreamLoader` must open the camera stream
...
class HttpsVideoStreamTest : RobolectricTestBase() {
  ...
  fun openStreamReadsFramesFromSelfSignedHttpsServer() {
    ...
    try {
      ...
      val stream = loader.openStream(URL("https://127.0.0.1:$port/?action=stream"))

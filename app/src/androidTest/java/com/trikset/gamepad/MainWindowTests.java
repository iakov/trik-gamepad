...
public class MainWindowTests {
  ...
  public static class SquareButtonTest {
    ...
    @Parameter public int currentPadId;
    ...
    public void initNetworkSettings() {
      ...
      preferenceEditor.putString(
          SettingsFragment.SK_HOST_PORT, Integer.toString(DummyServer.DEFAULT_PORT));
    ...
    private ViewAction diagonalTap() {
      return new ViewAction() {
        static final int tapSegmentCount = 10;
        ...
        public void perform(UiController uiController, View view) {
          ...
          final float[] startCoords = {
            topLeftCoords[0] + tapPrecision[0], topLeftCoords[1] - tapPrecision[1]
          };
          ...
          try {
            for (int i = 1; i < tapSegmentCount; ++i) {
              final float[] currentCoords = {
                startCoords[0] + (float) i * (view.getWidth()) / tapSegmentCount,
                startCoords[1] - (float) i * (view.getHeight()) / tapSegmentCount,
              };
    ...
    private ViewAction movingTap() {
      return new ViewAction() {
        ...
        public void perform(UiController uiController, View view) {
          ...
          view.getLocationOnScreen(topLeftCoords);
          int[] centerCoords = {
            topLeftCoords[0] + view.getWidth() / 2, topLeftCoords[1] + view.getWidth() / 2
          };

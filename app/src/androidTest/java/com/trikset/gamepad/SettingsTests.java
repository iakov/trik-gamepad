...
public class SettingsTests {
  ...
  public void settingsShouldWorkCorrectly() {
    ...
    ViewInteraction appCompatButton =
        onView(
            allOf(
                ...
                childAtPosition(
                    allOf(withId(R.id.main), childAtPosition(withId(android.R.id.content), 0)), 1),
                isDisplayed()));
    ...
    ViewInteraction appCompatButton2 =
        onView(
            allOf(
                ...
                withText("OK"),
                childAtPosition(
                    childAtPosition(withId(androidx.appcompat.R.id.buttonPanel), 0), 3)));
    appCompatButton2.perform(scrollTo(), click());

    ViewInteraction linearLayout2 =
        onView(
            allOf(
                childAtPosition(
                    allOf(
    ...
    ViewInteraction appCompatEditText18 =
        onView(
            allOf(
                withId(android.R.id.edit),
                withText("5000"),
    ...
    ViewInteraction appCompatEditText24 =
        onView(
            allOf(
                withId(android.R.id.edit),
                withText("3000"),
    ...
    ViewInteraction appCompatEditText25 =
        onView(
            allOf(
                withId(android.R.id.edit),
    ...
    ViewInteraction appCompatEditText26 =
        onView(
            allOf(
                withId(android.R.id.edit),
    ...
    ViewInteraction appCompatEditText27 =
        onView(
            allOf(
                withId(android.R.id.edit),
                withText("http://192.168.77.1:8080/?action=strea"),
    ...
    ViewInteraction appCompatEditText28 =
        onView(
            allOf(
                withId(android.R.id.edit),
                childAtPosition(
    ...
    ViewInteraction appCompatEditText29 =
        onView(
            allOf(
                withId(android.R.id.edit),
                childAtPosition(
                    childAtPosition(withClassName(is("android.widget.ScrollView")), 0), 1)));
    appCompatEditText29.perform(
        scrollTo(), replaceText("http://localhost:8080/?action=stream"), closeSoftKeyboard());
    ...
    ViewInteraction appCompatEditText31 =
        onView(
            allOf(
                withId(android.R.id.edit),

...
public class MjpegInputStream extends DataInputStream {
  ...
  private static final int FRAME_MAX_LENGTH = 300000 + HEADER_MAX_LENGTH;
  private static final byte[] SOI_MARKER = {(byte) 0xFF, (byte) 0xD8};

  // private final byte[] EOF_MARKER = {(byte) 0xFF, (byte) 0xD9};
  @NonNull
  private static final byte[] CONTENT_LENGTH_MARKER =
      Objects.requireNonNull(getUTF8Bytes(CONTENT_LENGTH));

...
public final class SenderService {
  ...
  @Nullable private PrintWriter mOut;
  ...
  @Nullable private static Executor mExecutor = Executors.newSingleThreadExecutor();

  @Nullable private static volatile AsyncTask<Void, Void, Void> mConnectTask;
